...
# 设置日志文件名（使用当前时间）
LOG_FILE="/ai/home/jcw/Project/scGPT/pretrain/logs/$(date +%Y%m%d_%H%M%S).log"
DISK_LOG_FILE="/ai/home/jcw/Project/scGPT/examppretrainles/logs/disk_usage_$(date +%Y%m%d_%H%M%S).log"
...
JOB_NAME="cellxgene_census_human"
LOG_INTERVAL=2000
