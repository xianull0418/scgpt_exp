...
amp = True
load_model = "/ai/home/jcw/scGPT_new/pretrain/save/scgpt0.5B-1.5epoch"
load_param_prefixs = [
    "encoder",
    "value_encoder",
    "transformer_encoder",
...
pert_data = PertData("/ai/home/jcw/Project/scGPT/tutorials/data")
...
def train(model: nn.Module, train_loader: torch.utils.data.DataLoader) -> None:
    ...
    for batch, batch_data in enumerate(train_loader):
        ...
        # 处理batch_data.x的形状问题
        x: torch.Tensor = batch_data.x  # shape [323840, 1]
        # 这里将x重塑为所需形状
        ori_gene_values = x.reshape(batch_size, n_genes)
        # 创建扰动标志(全零)
